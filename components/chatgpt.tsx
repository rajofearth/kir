...
import { PlusIcon, PaperclipIcon, SparkleIcon, BagIcon, MagicWandIcon, HandPointingIcon, DotsThreeOutlineIcon, ShareIcon, BookOpenIcon, GlobeIcon, PencilIcon, MicrophoneIcon, ArrowUpIcon, CaretDownIcon, GearIcon, FolderIcon, CheckCircleIcon, LightbulbIcon } from "@phosphor-icons/react"
              ...
              <FieldDescription className="flex flex-wrap gap-2">
                {categories.map((category) => (
                  ...
                  >
                    ...
                    >
                      <CheckCircleIcon data-icon="inline-start" className="hidden group-data-[checked=true]/badge:inline" />
                      {category.label}
                    </button>
                  </Badge>
                ))}
